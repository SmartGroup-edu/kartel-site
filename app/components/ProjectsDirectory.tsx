                  ...
                  return (
                    <tr key={p.key} className="border-b border-[var(--border)] align-top last:border-0">
                      <td className="px-4 py-4">
                        ...
                        <p className="mt-1 max-w-xs text-xs leading-relaxed text-[var(--muted)]">{p.summary}</p>
                      </td>
                      <td className="px-4 py-4"><RolePill value={(p as { role?: string }).role ?? "—"} /></td>
                      <td className="px-4 py-4"><StatusPill value={layers.identity} /></td>
                      <td className="px-4 py-4"><StatusPill value={layers.geography} /></td>
                      <td className="px-4 py-4"><StatusPill value={layers.organisation} /></td>
                    </tr>
                  );
                })}
              </tbody>
