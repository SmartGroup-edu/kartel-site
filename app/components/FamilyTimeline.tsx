...
const EVENTS: TimelineEvent[] = [
  ...
  },
  {
    ...
    descEN: "The earliest known generation of the Kartel family — the roots from which the family tree grew.",
    descRU: "Самое раннее известное поколение семьи Картель — корни, из которых выросло семейное древо.",
  },
  {
    id: "grandparents",
    yearEN: "Grandparents",
