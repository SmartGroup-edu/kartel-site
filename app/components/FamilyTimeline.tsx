...
const EVENTS: TimelineEvent[] = [
  ...
  },
  {
    ...
    descEN: "The founding generation of the Kartel family — the deepest roots of the family tree known to us.",
    descRU: "Поколение основателей рода Картель — самые глубокие корни семейного древа, известные нам.",
  },
  {
    id: "ancestors",
    yearEN: "Ancestors",
