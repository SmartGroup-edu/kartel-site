...
const EVENTS: TimelineEvent[] = [
  ...
  },
  {
    ...
    yearEN: "Ancestors",
    yearRU: "Прародители",
    titleEN: "Aleksandr Andreyevich & Lyubov Petrovna Kartel",
    titleRU: "Александр Андреевич и Любовь Петровна Картель",
  ...
  },
  {
    ...
    titleEN: "Nikolai Aleksandrovich & Valentina Aleksandrovna Kartel",
    titleRU: "Николай Александрович и Валентина Александровна Картель",
  ...
  },
  {
    ...
    titleEN: "Piotr Nikolaevich & Valentina Cheslavovna Kartel",
    titleRU: "Пётр Николаевич и Валентина Чеславовна Картель",
  ...
  },
  {
    ...
    yearEN: "Present",
    yearRU: "Настоящее",
    titleEN: "Igor Gor Petrovich & Diana Zenonovna Kartel",
    titleRU: "Игорь Гор Петрович и Диана Зеноновна Картель",
