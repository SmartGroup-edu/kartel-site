...
export const federationContent = {
  ...
  RU: {
    ...
    bandNote:
      "Счётчики людей округлены до диапазонов для приватности (0 · Active · 5–9 · 10–19 · 20+); точное значение ниже 5 для именованной сущности не публикуется. Счётчики целостности — структурные и точные.",
    publicNote:
