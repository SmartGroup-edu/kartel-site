...
export const familyContent = {
  EN: {
    ...
    people: [
      ...
      { name: "Piotr Kartel", description: "Representative of the elder generation of the Kartel family. 8 February 1955, Belarus — 3 January 2026, London. Laid to rest at the City of London Cemetery. In cherished memory.", generation: "elder" as Generation },
  ...
  RU: {
    title: "Семья Картель",
    intro:
      "Семья Картель предстаёт здесь как живая линия преемственности — семья, объединённая именем, памятью, ответственностью и осознанным сохранением наследия.",
    homeLabel: "Главная",
    familyLabel: "Семья",
    footerMotto: "Virtus et Potestas",
    ...
    people: [
      ...
      { name: "Петр Картель", description: "Представитель старшего поколения семьи Картель. 8 февраля 1955, Беларусь — 3 января 2026, Лондон. Похоронен на кладбище Сити-оф-Лондон. Светлая память.", generation: "elder" as Generation },
