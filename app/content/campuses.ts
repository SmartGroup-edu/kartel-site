...
export const campusesContent = {
  ...
  RU: {
    ...
    intro:
      "Канонические аккредитованные образовательные центры федерации. Кампус — это аккредитованный центр, который может иметь собственную аккредитацию, занятия и управление; он обозначается читаемым campusCode. KARTEL Core владеет реестром; платформы потребляют коды, но не создают их.",
    fields: {
      code: "Код кампуса",
      location: "Локация",
